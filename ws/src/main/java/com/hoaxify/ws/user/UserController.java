...
public class UserController {
    ...
    GenericMessage activateUser(@PathVariable String token) {
        userService.avtivateUser(token);
    ...
    UserDTO updaUserDTO(@PathVariable long id, @Valid @RequestBody UserUpdate userUpdate, @AuthenticationPrincipal CurrentUser currentUser) {
